...
- **DPI 选择**：LLM 输入图片默认 288 DPI（3× 标准屏幕分辨率），为 GPT-5.4 提供足够清晰的文字和布局细节以实现精确的字体大小估算；后处理阶段裁剪光栅图时仍使用 300 DPI 以保证输出质量
...
```json
{
  ...
  "token_estimate": {
    ...
    "assumed_output_tps": 50.0,
    "estimated_response_time_seconds": 1240.0
  },
  "estimated_response_time_seconds": 1240.0,
  "assumed_output_tps": 50.0
}
...
[14:30:52] INFO     main           Options: dpi=288, animations=off, model=gpt-5.4
[14:30:52] INFO     preprocessor   Rendering PDF pages at 288 DPI...
...
[14:30:59] INFO     token_est      Estimated response time: ~1240s (~20.7 min) at 50 tok/s
...
- 对于 288 DPI 的图片，1 像素 ≈ 0.25 pt ≈ 3175 EMU，这对于 LLM 的视觉分析和字体大小估算提供了良好的精度
